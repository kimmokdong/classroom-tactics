...
export const SYNERGIES = {
  subjects: {
    ...
    '과학': { name: '과학', desc: '피해 증폭 및 스킬 치명타', levels: { 2: { dmgAmp: 0.1 }, 4: { dmgAmp: 0.40, skillCrit: true, critChance: 0.2 } } },
    ...
    '도덕': { name: '도덕', desc: '[아군 전체] 방어/마저 버프 (도덕 유닛은 추가 뻥튀기)', levels: { 2: { teamDef: 20, selfDefMult: 2.2 }, 4: { teamDef: 30, selfDefMult: 2.4 }, 6: { teamDef: 100, selfDefMult: 3.5 } } }
  },
  clubs: {
    '선도부': { name: '선도부', desc: '시작 보호막 및 피해 증폭', levels: { 2: { startShieldPct: 0.10, dmgAmp: 0.05 }, 4: { startShieldPct: 0.20, dmgAmp: 0.15 }, 6: { startShieldPct: 0.30, dmgAmp: 0.30 } } },
    '방송부': { name: '방송부', desc: '거리 비례 피해 증폭', levels: { 3: { distAmp: 0.20 }, 5: { distAmp: 0.80 }, 7: { distAmp: 1.50, rangeBuff: 3 } } },
    '육상부': { name: '육상부', desc: '잃은 체력 비례 공격 속도 증가', levels: { 2: { maxAsBuff: 0.15 }, 4: { maxAsBuff: 0.3 }, 6: { maxAsBuff: 1.2 } } },
    '보건부': { name: '보건부', desc: '피해 감소', levels: { 2: { dmgReduc: 0.35 }, 4: { dmgReduc: 0.45 }, 6: { dmgReduc: 0.70 } } },
    '급식부': { name: '급식부', desc: '보호막 및 스택', levels: { 3: { startShield: 200, stackAdApPct: 0.005 }, 5: { startShield: 400, stackAdApPct: 0.01 }, 7: { startShield: 1200, stackAdApPct: 0.04 } } },
    '장난꾸러기': { name: '장난꾸러기', desc: '공격력 강화', levels: { 2: { adBuff: 0.3 }, 4: { adBuff: 0.8 }, 6: { adBuff: 1.5 } } }
  }
};
...
export const UNIT_POOL = [
  ...
  // 4-Cost (7 units)
  {
    ...
    skill: { name: '전력 태클', desc: '주변(3x3 반경 1칸) 적에게 피해 + 기절 + 본인에게 보호막 부여', type: 'aoe_damage_cc_shield', vfx: 'slam_yellow', aoeRange: 1, hpRatioDmg: [0.10, 0.20, 0.35], stunDuration: [20, 30, 40], hpRatioShield: [0.15, 0.25, 0.45] }
  },
  {
  ...
  },
  {
    ...
    skill: { name: '연쇄 폭발', desc: '타겟 중심 십자열(상하좌우) 적에게 마법 피해', type: 'cross_magic', vfx: 'fire_red', adRatio: [2.5, 4.0, 6.5] }
  },
  {
