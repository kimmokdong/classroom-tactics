...
export const UNIT_POOL = [
    ...
    { id: 'u1_2', name: '달리기 선수', subject: '체육', club: '육상부', tier: 1, icon: '🏃', manaType: '전투', stats: { hp: 450, mana: 0, maxMana: 60, ad: 55, ap: 100, armor: 20, mr: 20, as: 0.8, range: 1 },
    ...
    { id: 'u1_7', name: '과학탐구원', subject: '과학', club: '육상부', tier: 1, icon: '🔭', manaType: '전투', stats: { hp: 450, mana: 0, maxMana: 60, ad: 45, ap: 100, armor: 20, mr: 20, as: 0.75, range: 2 },
    ...
    { id: 'u1_10', name: '복도 지킴이', subject: '도덕', club: '보건부', tier: 1, icon: '🛑', manaType: '근성', stats: { hp: 550, mana: 0, maxMana: 80, ad: 35, ap: 100, armor: 35, mr: 30, as: 0.55, range: 1 },
      skill: { name: '출입금지', desc: '본인 마법저항력 증가 + 주변 적 도발', type: 'taunt', vfx: 'shield_gray', selfMrBuff: [0.3, 0.5, 0.8], tauntDuration: [30, 40, 50] } },
    ...
    { id: 'u2_4', name: '수학천재', subject: '수학', club: '육상부', tier: 2, icon: '📐', manaType: '전투', stats: { hp: 550, mana: 0, maxMana: 60, ad: 55, ap: 100, armor: 25, mr: 25, as: 0.8, range: 1 },
    ...
    // 3-Cost (9 units)
    { id: 'u3_1', name: '올림피아드 금상', subject: '수학', club: '선도부', tier: 3, icon: '🏆', manaType: '전투', stats: { hp: 800, mana: 0, maxMana: 70, ad: 50, ap: 100, armor: 40, mr: 40, as: 0.65, range: 1 },
    ...
    { id: 'u3_2', name: '양호실 도우미', subject: '도덕', club: '보건부', tier: 3, icon: '💊', manaType: '근성', stats: { hp: 750, mana: 40, maxMana: 120, ad: 40, ap: 100, armor: 35, mr: 35, as: 0.65, range: 2 },
      skill: { name: '응급 처치', desc: '체력 비율이 가장 낮은 아군 회복 + 보호막', type: 'heal_shield', vfx: 'heal_white', mrRatio: [1.5, 2.5, 4.0] } },
    { id: 'u3_3', name: '육상부 에이스', subject: '체육', club: '육상부', tier: 3, icon: '🥇', manaType: '전투', stats: { hp: 700, mana: 0, maxMana: 50, ad: 70, ap: 100, armor: 25, mr: 25, as: 0.9, range: 1 },
    ...
    { id: 'u3_4', name: '발명품 매니아', subject: '과학', club: '장난꾸러기', tier: 3, icon: '💡', manaType: '전투', stats: { hp: 650, mana: 0, maxMana: 80, ad: 60, ap: 100, armor: 20, mr: 30, as: 0.75, range: 2 },
      skill: { name: '폭탄 투척', desc: '가장 밀집된 적 주변 광역 마법 피해', type: 'aoe_magic_cluster', vfx: 'fire_red', aoeRange: 1, adRatio: [2.5, 3.5, 5.5] } },
    ...
    { id: 'u3_6', name: '시조 읊는 선비', subject: '국어', club: '급식부', tier: 3, icon: '🍵', manaType: '근성', stats: { hp: 700, mana: 0, maxMana: 90, ad: 50, ap: 100, armor: 30, mr: 45, as: 0.65, range: 2 },
      skill: { name: '선비의 기개', desc: '아군 전체 주문력 증가 + 적 전체 마저 감소', type: 'team_buff_enemy_debuff', vfx: 'buff_green', buffStat: 'ap', buffPct: [0.3, 0.5, 0.8], enemyMrReduc: [15, 25, 40], buffDuration: [50, 60, 80] } },
    ...
    { id: 'u4_1', name: '전교 체육부장', subject: '체육', club: '선도부', tier: 4, icon: '🦍', manaType: '근성', stats: { hp: 1150, mana: 0, maxMana: 100, ad: 80, ap: 100, armor: 65, mr: 65, as: 0.7, range: 1 },
      skill: { name: '전력 태클', desc: '주변 넓은 범위 적에게 피해 + 기절 + 본인에게 보호막 부여', type: 'aoe_damage_cc_shield', vfx: 'slam_yellow', aoeRange: 2, hpRatioDmg: [0.15, 0.25, 0.4], stunDuration: [20, 30, 40], hpRatioShield: [0.2, 0.3, 0.5] } },
    { id: 'u4_2', name: '수능 만점자', subject: '수학', club: '방송부', tier: 4, icon: '💯', manaType: '전투', stats: { hp: 950, mana: 50, maxMana: 120, ad: 90, ap: 100, armor: 40, mr: 40, as: 0.9, range: 3 },
    ...
    { id: 'u4_4', name: '논술의 신', subject: '국어', club: '육상부', tier: 4, icon: '✍️', manaType: '전투', stats: { hp: 1000, mana: 0, maxMana: 80, ad: 105, ap: 100, armor: 50, mr: 40, as: 0.9, range: 1 },
      skill: { name: '필살의 논리', desc: '단일 대상 강력한 물리 피해', type: 'single_damage', vfx: 'slam_yellow', adRatio: [6.0, 9.0, 15.0] } },
    { id: 'u4_5', name: '전교 학생회장', subject: '사회', club: '급식부', tier: 4, icon: '👑', manaType: '근성', stats: { hp: 1100, mana: 0, maxMana: 140, ad: 60, ap: 100, armor: 45, mr: 45, as: 0.65, range: 1 },
    ...
    { id: 'u4_6', name: '나이팅게일', subject: '도덕', club: '보건부', tier: 4, icon: '🕊️', manaType: '집중', stats: { hp: 1050, mana: 60, maxMana: 150, ad: 55, ap: 100, armor: 50, mr: 65, as: 0.7, range: 3 },
      skill: { name: '천사의 손길', desc: '아군 전체 회복 + 가장 많이 다친 아군 추가 회복', type: 'team_heal_plus', vfx: 'heal_white', defMrRatio: [1.0, 1.5, 2.5], extraHealPct: [0.1, 0.15, 0.25] } },
    ...
    // 5-Cost (4 units)
    { id: 'u5_1', name: '외고 전학생', subject: '영어', club: '육상부', tier: 5, icon: '✈️', manaType: '전투', stats: { hp: 1200, mana: 0, maxMana: 100, ad: 110, ap: 100, armor: 45, mr: 45, as: 1.1, range: 2 },
      skill: { name: '글로벌 스트라이크', desc: '공격 속도 증가 + 사거리 증가 + 추가 고정 피해', type: 'self_buff_hyper', vfx: 'buff_green', asBuff: [0.8, 1.2, 2.0], rangeBuff: [2, 3, 4], bonusTrueDmg: [100, 150, 250], asRatio: [100, 150, 250], buffDuration: [100, 100, 100] } },
    ...
    { id: 'u5_3', name: '피카소의 재림', subject: '미술', club: '장난꾸러기', tier: 5, icon: '🧑‍🎨', manaType: '전투', stats: { hp: 1050, mana: 40, maxMana: 120, ad: 100, ap: 100, armor: 35, mr: 35, as: 0.95, range: 3 },
      skill: { name: '명작 탄생', desc: '적 전체 마법 피해 + 아군 전체 영구 버프 및 보호막 부여', type: 'global_magic_team_buff', vfx: 'magic_purple', adRatio: [3.0, 5.0, 8.0], teamStatBuff: [0.2, 0.3, 0.5] } },
