...
export const UNIT_POOL = [
    ...
    { id: 'u3_3', name: '육상부 에이스', subject: '체육', club: '육상부', tier: 3, icon: '🥇', manaType: '전투', stats: { hp: 700, mana: 0, maxMana: 50, ad: 70, ap: 100, armor: 25, mr: 25, as: 0.9, range: 1 },
      skill: { name: '미친 스퍼트', desc: '공격 속도 대폭 증가', type: 'self_buff', vfx: 'buff_green', buffType: 'attackSpeed', asBuff: [0.8, 1.2, 2.0], buffDuration: [50, 70, 100] } },
    ...
    { id: 'u5_1', name: '외고 전학생', subject: '영어', club: '육상부', tier: 5, icon: '✈️', manaType: '전투', stats: { hp: 1200, mana: 0, maxMana: 100, ad: 110, ap: 100, armor: 45, mr: 45, as: 1.1, range: 2 },
      skill: { name: '글로벌 스트라이크', desc: '공격 속도 증가 + 사거리 증가 + 추가 고정 피해', type: 'self_buff_hyper', vfx: 'buff_green', asBuff: [0.8, 1.2, 2.0], rangeBuff: [2, 3, 4], bonusTrueDmg: [50, 100, 200], asRatio: [100, 150, 250], buffDuration: [60, 60, 60] } },
