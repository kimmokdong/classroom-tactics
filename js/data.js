...
export const UNIT_POOL = [
    ...
    { id: 'u2_3', name: '문학소녀', subject: '국어', club: '보건부', tier: 2, icon: '📚', manaType: '집중', stats: { hp: 500, mana: 40, maxMana: 100, ad: 30, ap: 100, armor: 20, mr: 30, as: 0.6, range: 3 },
      skill: { name: '영감의 시', desc: '아군 전체 공격 속도 증가', type: 'team_buff', vfx: 'buff_green', buffStat: 'as', buffPct: [0.3, 0.4, 0.6], buffDuration: [50, 60, 80] } },
    ...
    { id: 'u3_1', name: '올림피아드 금상', subject: '수학', club: '선도부', tier: 3, icon: '🏆', manaType: '전투', stats: { hp: 800, mana: 0, maxMana: 70, ad: 50, ap: 100, armor: 40, mr: 40, as: 0.65, range: 1 },
      skill: { name: '완벽한 풀이', desc: '대상에게 방어력을 관통하는 단일 물리 피해', type: 'single_damage', vfx: 'slam_yellow', adRatio: [4.4, 6.6, 11.0], armorPen: [0.55, 0.715, 0.88] } },
    ...
    { id: 'u3_3', name: '육상부 에이스', subject: '체육', club: '육상부', tier: 3, icon: '🥇', manaType: '전투', stats: { hp: 700, mana: 0, maxMana: 50, ad: 70, ap: 100, armor: 25, mr: 25, as: 0.9, range: 1 },
      skill: { name: '미친 스퍼트', desc: '공격 속도 대폭 증가', type: 'self_buff', vfx: 'buff_green', buffType: 'attackSpeed', asBuff: [1.1, 1.65, 2.75], buffDuration: [80, 100, 120] } },
    ...
    { id: 'u3_5', name: '사회탐구 1타', subject: '사회', club: '방송부', tier: 3, icon: '🗺️', manaType: '집중', stats: { hp: 600, mana: 40, maxMana: 100, ad: 45, ap: 100, armor: 25, mr: 40, as: 0.7, range: 4 },
      skill: { name: '세계화 전략', desc: '가장 먼 적에게 마법 피해', type: 'farthest_magic', vfx: 'magic_purple', apRatio: [3.3, 4.95, 7.7] } },
    { id: 'u3_6', name: '시조 읊는 선비', subject: '국어', club: '급식부', tier: 3, icon: '🍵', manaType: '근성', stats: { hp: 700, mana: 0, maxMana: 90, ad: 50, ap: 100, armor: 30, mr: 45, as: 0.65, range: 2 },
      skill: { name: '선비의 기개', desc: '아군 전체 주문력 증가 + 적 전체 마저 감소', type: 'team_buff_enemy_debuff', vfx: 'buff_green', buffStat: 'ap', buffPct: [0.33, 0.55, 0.88], enemyMrReduc: [16.5, 27.5, 44], buffDuration: [50, 60, 80] } },
    { id: 'u3_7', name: '영어 프리토커', subject: '영어', club: '방송부', tier: 3, icon: '🗣️', manaType: '집중', stats: { hp: 600, mana: 20, maxMana: 80, ad: 55, ap: 100, armor: 20, mr: 25, as: 0.75, range: 3 },
      skill: { name: '토론 압살', desc: '대상 마나 소멸 + 마법 피해', type: 'mana_burn', vfx: 'debuff_dark', manaBurnPct: [0.55, 0.825, 1.1], apRatio: [2.75, 4.18, 6.6] } },
    ...
    { id: 'u3_9', name: '수채화 장인', subject: '미술', club: '선도부', tier: 3, icon: '🎨', manaType: '집중', stats: { hp: 750, mana: 30, maxMana: 100, ad: 45, ap: 100, armor: 40, mr: 30, as: 0.6, range: 2 },
      skill: { name: '색의 마법', desc: '랜덤 적에게 마법 피해 + 마나 봉인', type: 'random_aoe_debuff', vfx: 'magic_purple', targetCount: 4, apRatio: [1.98, 3.08, 4.95], manaReducPct: [1.1, 1.1, 1.1], debuffDuration: [30, 40, 50] } },
