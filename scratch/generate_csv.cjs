...
let csv = '\uFEFF';
csv += '8L순위,9L순위,순위변동,덱 아키타입,8L 밸류,8L 승률,8L 가성비,9L 밸류,9L 승률,9L 가성비\n';
...
for (let i = 0; i < 25; i++) {
    ...
    csv += `${d8.rank},${d9_rank},${rankChange},${d8.name},${d8.gold},${d8.winrate},${d8.balance},${d9_gold},${d9_wr},${d9_bal}\n`;
}

fs.writeFileSync('./scratch/meta_tier_list.csv', csv);
