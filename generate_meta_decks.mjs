...
const BOARD_SIZE = 8; // 8레벨 종결 덱 기준
...
function generateDecks() {
    ...
    fs.writeFileSync('./js/meta_decks.json', JSON.stringify(decks, null, 2));
    console.log(`✅ 성공적으로 ${decks.length}개의 메타 덱을 js/meta_decks.json에 저장했습니다.`);
}
